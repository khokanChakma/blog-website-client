            ...
            <div className="navbar container mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            tabIndex={0}
                            className="menu font-bold text-lg bg-gray-400 text-white menu-sm dropdown-content rounded-box z-[50] mt-3 w-52 p-2 shadow">
                            ...
                            <NavLink className='rounded' to='/contact'><li><a>Contact</a></li></NavLink>
                        </ul>
                    </div>
                    <Link to='/'>
                        <a className="cursor-pointer flex gap-2 items-center">
                            <img className="w-12" src={logo} alt="" />
                            <h2 className="text-xl text-[#007279] font-bold">The Blog Haven</h2>
                        </a>
                    </Link>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal text-gray-600 px-1 font-bold">
